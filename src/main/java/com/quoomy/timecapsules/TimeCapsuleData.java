...
public class TimeCapsuleData
{
    ...
    public static TimeCapsuleData fetchTimeCapsuleData()
    {
        ...
        try
        {
            ...
            {
                Timecapsules.LOGGER.error("Failed to fetch time capsule data: HTTP error code {}", connection.getResponseCode());
                data.setValid(false);
                return data;
            }
        ...
        {
            Timecapsules.LOGGER.error("Failed to fetch time capsule data: {}", e.getMessage());
            data.setValid(false);
        }
